...
<div class="container mx-auto flex flex-col md:flex-row md:space-x-8">
    <div class="flex-1"></div> <!-- Sidebar placeholder agar layout tetap rapi -->
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-4">
                            ...
                            <span id="mood_score_display" class="text-lg font-semibold text-gray-900 w-8 text-center">5</span>
                        </div>
